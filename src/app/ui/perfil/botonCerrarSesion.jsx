...
const BotonCerrarSesion = () => {
  ...
  return (
    <div>
      ...
      <button className='flex items-center py-2 px-4' onClick={handleModal}>
                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          <Dialog.Title onClick={BotonCerrarSesion} as="h3" className="text-base font-semibold leading-6 text-gray-900">
                            Cerrar sesion
                          </Dialog.Title>
                          <div className="mt-2">
